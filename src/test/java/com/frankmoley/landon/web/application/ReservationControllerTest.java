...
public class ReservationControllerTest {
    ...
    private static final String dateString = "2017-01-01";
    ...
    public void getReservations() throws Exception{
        ...
        mockRoomReservation.setLastName("Hello");
        ...
        this.mockMvc.perform(
        		get("/reservations?date=2017-01-01")).andExpect(status().isOk()).andExpect(content().string(containsString("Hello, JUnit")));
    }
}
